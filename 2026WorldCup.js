...
// Tradução dos nomes das seleções: o identificador interno (usado para
// corresponder aos nomes no manifest.json remoto dos avatares) mantém-se
// em chinês; aqui faz-se apenas a tradução para o nome mostrado ao utilizador.
const TEAM_NAME_PT = {
  "墨西哥": "México",
  "南非": "África do Sul",
  "韩国": "Coreia do Sul",
...
// Devolve o nome da seleção em português para exibição; mantém o identificador
// interno (chinês) inalterado para não quebrar a correspondência com o manifest.
function displayName(name) {
  return TEAM_NAME_PT[name] || name;
}

// Emojis de bandeira por identificador interno da seleção (mesmo nome usado no manifest)
const FLAGS = {
  "墨西哥": "🇲🇽", "南非": "🇿🇦", "韩国": "🇰🇷", "捷克": "🇨🇿",
  "加拿大": "🇨🇦", "波黑": "🇧🇦", "卡塔尔": "🇶🇦", "瑞士": "🇨🇭",
  "巴西": "🇧🇷", "摩洛哥": "🇲🇦", "海地": "🇭🇹", "苏格兰": "🏴",
...
// Mapa de nomes da ESPN (em inglês) para o identificador interno da seleção.
// Mantém-se em chinês porque tem de corresponder aos nomes usados no
// manifest.json remoto dos avatares; a tradução para português é feita
// apenas na exibição (ver displayName / TEAM_NAME_PT).
const ESPN_NAME_MAP = {
  "Mexico": "墨西哥",
  "South Africa": "南非",
  "South Korea": "韩国",
...
// identificador interno da seleção (chinês, ver displayName)
